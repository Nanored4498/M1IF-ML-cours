...
Ainsi, si $X^\trans X$ est inversible, \fbox{\boldmath $\theta = (X^\trans X)^{-1} X^\trans y$} convient. En revanche si $X^\trans X$ n'est pas inversible, il est possible que des features soient redondants. Appliqué l'algorithme PCA peut alors être une solution.
